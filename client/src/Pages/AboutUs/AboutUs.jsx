...
export default function AboutUs() {
  return (
    <div className="bg-[oklch(0.95_0.06_115)] text-zinc-950">
      {/* Hero Section */}
      <section className="px-6 py-16 bg-[oklch(0.70_0.13_125)]">
        <div className="flex flex-col-reverse items-center gap-10 mx-auto max-w-7xl md:flex-row">
          ...
          <div className="flex-1 text-center md:text-left">
            <h1 className="text-4xl font-bold md:text-5xl text-lime-800">
              About Greenifiy
            </h1>
            <p className="mt-4 text-lg leading-relaxed text-zinc-950/80">
      ...
      <section className="px-6 py-16">
        <div className="max-w-5xl mx-auto text-center">
          <h2 className="text-3xl font-semibold text-lime-800">Our Story</h2>
          <p className="mt-6 leading-relaxed text-zinc-950/80">
      ...
      <section className="px-6 py-16 bg-[oklch(0.95_0.06_115)]">
        <div className="grid items-center max-w-6xl grid-cols-1 gap-10 mx-auto md:grid-cols-2">
          {/* Text */}
          <div>
            <h2 className="text-3xl font-semibold text-lime-800">
              Our Mission & Values
            </h2>
            <p className="mt-4 leading-relaxed text-zinc-950/80">
            ...
            <ul className="mt-6 space-y-2 list-disc list-inside text-zinc-950">
      ...
      <section className="px-6 py-16 bg-[oklch(0.70_0.13_125)]/30">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="max-w-3xl mx-auto mt-4 leading-relaxed text-zinc-950/80">
          ...
          <div className="grid grid-cols-1 gap-8 mt-10 sm:grid-cols-2 md:grid-cols-3">
            {[1, 2, 3].map((i) => (
              ...
              >
                ...
                <h3 className="mt-4 text-lg font-semibold text-lime-800">
                  Team Member {i}
                </h3>
                <p className="text-sm text-zinc-950/70">Plant Specialist</p>
              </div>
            ))}
          </div>
        </div>
